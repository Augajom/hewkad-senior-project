...
const API = import.meta.env?.VITE_API_URL || "https://hewkad.com:8443";
                            ...
                            {report.report_file ? (
                              <button
                                onClick={() =>
                                  setViewModal({
                                    open: true,
                                    fileUrl: `https://hewkad.com:8443${report.report_file}`,
                                    title: "Report File",
                                  })
                                }
                            ...
                            {report.status_id === 6 ? (
                              ...
                              <button
                                onClick={() =>
                                  setViewModal({
                                    open: true,
                                    fileUrl: `https://hewkad.com:8443${report.resolved_file}`,
                                    title: "Resolved File",
                                  })
                                }
