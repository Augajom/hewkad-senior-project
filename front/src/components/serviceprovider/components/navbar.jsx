...
function Navbar({ orderingCount = 0, onSearchSubmit }) {
  ...
  return (
    <div className="w-full">
      {/* Top header (same vibe as user navbar) */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="h-16 flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-2">
              ...
              <Link to="/service/chat">
                <button
                  className={`btn btn-ghost btn-circle ${
                    isActive("/service/chat")
                      ? "text-cyan-600"
                      : "text-slate-900 hover:text-cyan-600"
                  }`}
                  aria-label="Messages"
        ...
        {open && (
          <div className="md:hidden border-t border-slate-200/60 bg-white/80">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 space-y-3">
              ...
              {/* Mobile links */}
              <Link to="/service/ordering" onClick={() => setOpen(false)}>
                <div
              ...
              <Link to="/service/payment" onClick={() => setOpen(false)}>
                <div
              ...
              <Link to="/service/chat" onClick={() => setOpen(false)}>
                <div
                  className={`flex items-center gap-2 px-3 py-2 rounded-xl ${
                    isActive("/service/chat")
                      ? "bg-cyan-50 text-cyan-700"
              ...
              <Link to="/service/profile" onClick={() => setOpen(false)}>
                <div
                  className={`flex items-center gap-2 px-3 py-2 rounded-xl ${
                    isActive("/service/profile")
                      ? "bg-cyan-50 text-cyan-700"
