        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-slate-200/50 p-8">
              ...
              <div className="space-y-6">
                <InfoField icon={<CreditCard className="w-5 h-5" />} label="Bank Name" name="bank" value={editUser.bank} displayValue={user.bank} editMode={editMode} onChange={handleChange} />
