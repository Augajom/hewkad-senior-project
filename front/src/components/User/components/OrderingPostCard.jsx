...
const OrderingPostCard = ({ post }) => {
    ...
    const fetchReasons = async () => {
      try {
        const res = await fetch(
          "https://hewkad.com:2053/customer/report-reasons",
          {
            credentials: "include",
          }
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("https://hewkad.com:2053/customer/upload-slip", {
        method: "POST",
        body: formData,
        credentials: "include",
      });
  ...
  const handleOpenQR = async () => {
    try {
      const res = await fetch(
        `https://hewkad.com:2053/customer/payment/qr/${post.id}`,
        {
          credentials: "include",
        }
      );
  ...
  const handleConfirmPayment = async () => {
    try {
      const res = await fetch(
        `https://hewkad.com:2053/customer/orders/${post.id}`,
        {
          method: "PUT",
  ...
  const handleReportSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://hewkad.com:2053/customer/reports", {
        method: "POST",
        credentials: "include",
        body: formData,
      });
  ...
  const handleConfirmOrder = async () => {
    try {
      const res = await fetch(
        `https://hewkad.com:2053/customer/confirmorder/${post.id}`,
        {
          method: "PUT",
          credentials: "include",
          headers: { "Content-Type": "application/json" },
            ...
            src={
              post.avatar
                ? post.avatar.startsWith("http")
                  ? post.avatar
                  : `https://hewkad.com:2053${post.avatar}`
          ...
          <dialog className="modal modal-open">
            <div className="modal-box bg-white p-6 rounded-lg shadow-xl text-black">
              ...
              <div className="flex justify-center mb-6">
                <img
                  src={`https://hewkad.com:2053${post.proof_url}`}
                  alt="Proof"
